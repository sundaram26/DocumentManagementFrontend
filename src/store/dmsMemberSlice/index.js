...
export const createMeetingReport = createAsyncThunk(
    ...
    async (formData) => {
        ...
        const response = await axios.post(
            `https://document-management-o9x0.onrender.com/api/v1/members/dms/meeting-reports`,
            formData,
  ...
  async (meetingId, { rejectWithValue }) => {
    try {
      const response = await axios.delete(
        `https://document-management-o9x0.onrender.com/api/v1/members/dms/meeting-reports/${meetingId}`,
        { withCredentials: true }
      );
...
export const createDmsMeetingDraft = createAsyncThunk(
    ...
    async (formData , { rejectWithValue }) => {
      try {
        const response = await axios.post(
          `https://document-management-o9x0.onrender.com/api/v1/members/dms/draft-meeting`,
          formData,
          { withCredentials: true }
        );
        return response.data;
...
export const deleteDmsMeetingDraft = createAsyncThunk(
    ...
    async (draftId, { rejectWithValue }) => {
      try {
        const response = await axios.delete(
          `https://document-management-o9x0.onrender.com/api/v1/members/dms/draft-meeting/${draftId}`,
          { withCredentials: true }
        );
        return response.data;
      } catch (error) {
...
export const activityReport = createAsyncThunk(
    ...
    async (formData, { rejectWithValue }) => {
        try {
            const response = await axios.post(
            `https://document-management-o9x0.onrender.com/api/v1/members/dms/activity-reports`,
            formData,
            { withCredentials: true }
            );
            return response.data;
...
export const deleteActivity = createAsyncThunk(
  ...
  async (activityId, { rejectWithValue }) => {
    try {
      const response = await axios.delete(
        `https://document-management-o9x0.onrender.com/api/v1/members/dms/activity-reports/${activityId}`,
        { withCredentials: true }
      );
      return response.data;
    } catch (error) {
...
export const createActivityDraft = createAsyncThunk(
    ...
    async (formData , { rejectWithValue }) => {
      try {
        const response = await axios.post(
          `https://document-management-o9x0.onrender.com/api/v1/members/dms/draft-activity`,
          formData,
          { withCredentials: true }
        );
        return response.data;
...
export const deleteActivityDraft = createAsyncThunk(
    ...
    async (draftId, { rejectWithValue }) => {
      try {
        const response = await axios.delete(
          `https://document-management-o9x0.onrender.com/api/v1/members/dms/draft-activity/${draftId}`,
          { withCredentials: true }
        );
        return response.data;
      } catch (error) {
