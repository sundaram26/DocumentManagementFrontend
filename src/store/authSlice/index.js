...
export const registerUser = createAsyncThunk(
    ...
    async (formData) => {
        const response = await axios.post(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/register`, 
            formData, 
...
export const verifyEmail = createAsyncThunk(
    ...
    async (verificationCode) => {
        const response = await axios.post(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/verify-otp`,
            { verificationCode },
            { withCredentials: true }
        );
        return response.data;
...
export const resendVerificationEmail = createAsyncThunk(
    ...
    async () => {
        const response = await axios.post(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/resend-otp`,
            {},
            { withCredentials: true }
        );
        return response.data;
...
export const loginUser = createAsyncThunk(
    ...
    async (formData) => {
        ...
        const response = await axios.post(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/login`,
            formData,
            { withCredentials: true }
        );
...
export const forgotPassword = createAsyncThunk(
    ...
    async (email, { rejectWithValue }) => {
        try {
            const response = await axios.post(
                `https://documentmanagement-8vku.onrender.com/api/v1/users/forgot-password`,
                { email },
                {withCredentials:true}
            );
            return response.data;
...
export const resetPassword = createAsyncThunk(
    ...
    async ({ token, password }, { rejectWithValue }) => {
        try {
            const response = await axios.post(
                `https://documentmanagement-8vku.onrender.com/api/v1/users/reset-password/${token}`, // Use the token in the URL
                { password },
                { withCredentials: true }
            );
            return response.data; 
...
export const checkAuth = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/check-auth`,
            {
                withCredentials: true,
                headers: {
...
export const logoutUser = createAsyncThunk(
    ...
    async () => {
        const response = await axios.post(
            `https://documentmanagement-8vku.onrender.com/api/v1/users/logout`,
            {},
            { withCredentials: true }
        )
