...
export const fetchUnapprovedUsers = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(
            `https://rotaractanddmsclub.onrender.com/api/v1/admin/requests`, 
    ...
    async (userId, { rejectWithValue }) => {
        try {
            const response = await axios.patch(
                `https://rotaractanddmsclub.onrender.com/api/v1/admin/approve-user/${userId}`,
                {},
                { withCredentials: true }
            );
    ...
    async (userId, {rejectWithValue}) => {
        try{
            const response = await axios.post(
                `https://rotaractanddmsclub.onrender.com/api/v1/admin/disapprove-user/${userId}`,
                {},
                { withCredentials: true }
            );
            return response.data;
...
export const fetchUsers = createAsyncThunk(
    'admin/fetchUsers',
    async () => {
    const response = await axios.get(`https://rotaractanddmsclub.onrender.com/api/v1/admin/get-users`);
...
export const fetchReportsByUser = createAsyncThunk(
    ...
    async (userId, { rejectWithValue }) => {
        try {
            const response = await axios.get(`https://rotaractanddmsclub.onrender.com/api/v1/reports/user-reports/${userId}`, {
                withCredentials: true
            });
