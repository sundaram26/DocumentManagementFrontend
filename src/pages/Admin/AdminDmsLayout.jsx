...
const AdminDmsLayout = () => {
  ...
  const handleActivityView = (userId) => {
    navigate(`/admin/admin-dms/${userId}/activities`);
  };
  
  const handleMeetingView = (userId) => {
    navigate(`/admin/admin-dms/${userId}/meetings`);
  };

  return (
    <div className='w-full p-4'>
      <p className='text-2xl font-semibold'>DMS Members</p>
      ...
      <div className='p-4 m-4 bg-white shadow-[0px_4px_12px_rgba(0,0,0,0.2)] rounded-lg overflow-hidden'>
        <div className='w-full text-md font-semibold flex justify-between items-center bg-gray-100 p-2 my-2 rounded-xl'>
            ...
            <div className='w-[10%] uppercase flex justify-center'>Activity</div>
                ...
                ? (filteredUsers.map((user) => (
                    <div key={user._id} className='w-full text-lg flex justify-between items-center p-2 my-1 rounded-xl'>
                        ...
                        <div className='w-[10%] flex justify-center'>
                            <button onClick={() => handleActivityView(user._id)} className='text-blue-500'><FaEye /></button>
                        </div>
                        <div className='w-[10%] flex justify-center'>
