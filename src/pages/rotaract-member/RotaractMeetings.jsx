...
import { getRotaractMeetingByUser } from '../../store/rotaractMemberSlice';
import Modal from '../../components/common/Modal';
import RotaractMeetingView from './RotaractMeetingView';
...
const RotaractMeetings = () => {
    ...
    useEffect(() => {
        const fetchReports = async () => {
            try {
                await dispatch(getRotaractMeetingByUser({ userId: user._id, page: pageIndex + 1, limit: PAGE_SIZE, searchQuery: searchQuery }));
            } catch (err) {
    ...
    const handleSearch = (e) => {
        ...
        setPageIndex(0);
        navigate(`/member/rotaract-member/meetings?page=1&searchQuery=${query}`);
    };
    ...
    const handlePageChange = (newPageIndex) => {
        if (newPageIndex >= 0 && newPageIndex < rotaractMeetingByUser.totalPages) {
            ...
            navigate(`/member/rotaract-member/meetings?page=${newPageIndex + 1}`);
        }
    };
    ...
    <div className='w-full min-h-[calc(100vh-99px)]'>
        ...
        <div className='w-full h-40 flex justify-around items-center'>
            ...
            <div className='flex gap-2'>
                <Link to='/member/rotaract-member/meetings/meeting-report'>
                ...
                <Link to='/member/rotaract-member/meetings/drafts'>
...
export default RotaractMeetings